...
post.innerHTML =   <div class="post-header">   <a href="profile.html"><img src="user.jpg" alt="Profile"></a>   <div>   <div class="name">Humayun Danish</div>   <div class="time">${formatTime(postData.time)}</div>   </div>   </div>   <div class="post-content">   ${postData.text ?<p>${postData.text}</p>` : ""}
</div>
...
document.getElementById("greeting").innerHTML =   <div>   <strong>${greeting}, Humayun!</strong><br />   <small>${message}</small>   </div>  ;
